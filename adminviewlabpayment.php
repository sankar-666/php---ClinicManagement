...
<table class="table"> 
 ...
 inner join labtests using (lab_test_id) inner join payments on payments.book_id = testprescription.test_pres_id where patient_id='$pid' and booking_id='$bid'  AND paymenttype='test Payment'";
  $res=select($q);
